...
public class NioEndpoint extends AbstractJsseEndpoint<NioChannel> {
    ...
    public void bind() throws Exception {
        ...
        // 初始化 Selector，但是还没有和 ServerSocketChannel 进行绑定
        selectorPool.open();
    }
    ...
    public void startInternal() throws Exception {
        ...
        if (!running) {
            ...
            for (int i = 0; i < pollers.length; i++) {
                ...
                // 在 jstack 中对应的线程是：http-nio-8080-ClientPoller-0
                // 在 jstack 中对应的线程是：http-nio-8080-ClientPoller-1
                // 这些东西都是借助于线程启动的
...
//                        System.out.println(Thread.currentThread().getName() + "end");
    ...
    public class Poller implements Runnable {
        ...
        private void addEvent(PollerEvent event) {
            events.offer(event);
            // 如果没有可用的 Selector，wakeup 解除阻塞，说明来活了
        ...
        public boolean events() {
            ...
            PollerEvent pe = null;
            // 在这儿正常情况下是能获取到事件的，因为在唤醒 selector 之前，是有事件加入的。
            ...
            try {
                if (close) {
                    ...
                    if (sk.isReadable() || sk.isWritable()) {
                        // 如果是零拷贝，Sendfile，调用 FileChannel.sendFile();
